describe('Process lot', function () {
    ...
    describe('Starts the Oven - Horno / Drying - Secado In Process', function () {
        describe('Insert the holder ' + rackIn + '', function () {
            ...
            it('11 - Display error message "Holder Empty"', function () {
                cy.get('#swal2-title').should('contain', 'Holder Empty');
                //cy.screenshot();
                cy.wait(1000);
                cy.get('button').contains('OK').click();
            ...
            it('12 - Enter correct holder in', function () {
                ...
                cy.get('#rackInput').should('have.class', 'form-group has-success has-feedback');
                cy.get('#rackCheck').should('have.class', 'glyphicon glyphicon-ok form-control-feedback');
                cy.get('#ProcessIn').should('contain', 'Horno/Oven Dry');
                cy.get('#qtyIn').should('be.disabled');
            ...
            it('17 - Enter correct ED value', function () {
                cy.get('#edIn').clear();
            ...
            it('18 - Enter higher Oven Temperature value', function () {
                ...
                //cy.screenshot();
                cy.get('#tempModal').tab({ shift: true });
                cy.wait(1000);
            });
            it('19 - Display error message "Wrong Temperature"', function () {
                cy.get('#swal2-title').should('contain', 'Wrong Temperature');
                //cy.screenshot();
                cy.wait(1000);
                cy.get('button').contains('OK').click();
                cy.get('#rackInput').should('have.class', 'form-group has-success has-feedback');
                ...
                cy.get('#btnValidate').should('be.enabled');
                cy.get('#userIn').should('be.disabled');
                cy.get('#passIn').should('be.disabled');
                cy.get('#saveIn').should('be.disabled');
            });
            ...
            it('22 - Enter correct Oven Temperature value', function () {
                cy.get('#tempModal').clear();
                cy.get('#tempModal').type('135', { delay: 100 });
                cy.get('#tempModal').tab({ shift: true });
                cy.wait(1000);
                cy.get('#rackInput').should('have.class', 'form-group has-success has-feedback');
                cy.get('#rackCheck').should('have.class', 'glyphicon glyphicon-ok form-control-feedback');
        ...
        describe('Insert the holder ' + rackIn2 + '', function () {
    ...
    describe('Starts the Oven - Horno / Drying - Secado Out process', function () {
        describe('Take out the holder ' + rackIn2 + '', function () {
            ...
            it('76 - Enter correct holder in', function () {
                ...
                cy.get('#rackInput').should('have.class', 'form-group has-success has-feedback');
                cy.get('#rackCheck').should('have.class', 'glyphicon glyphicon-ok form-control-feedback');
                cy.get('#ProcessOut').should('contain', 'Horno/Oven Dry to End Process');
            ...
            it('79 - Enter correct holder out', function () {
                ...
                cy.get('#rejectMin').should('be.disabled');
                cy.get('#rejectPlus').should('be.disabled');
                cy.get('#userOut').should('be.enabled');
                cy.get('#passOut').should('be.disabled');
                cy.get('#saveOut').should('be.disabled');
                //cy.screenshot();
            });
        ...
        describe('Take out the holder ' + rackIn + '', function () {
            ...
            it('111 - Type a good password', function () {
                ...
                cy.get('#passOut').tab({ shift: true });
                cy.wait(1000);
                cy.get('#saveOut').should('be.enabled');
                cy.get('#rejectMin').should('be.disabled');
                cy.get('#rejectPlus').should('be.disabled');
                cy.wait(1000);
                //cy.screenshot();
            });
            it('112 - Waiting until the process time is complete', function () {
                cy.wait(179000);
                //cy.screenshot();
            });
