describe('Raw Material Mix', function () {
	describe('Acceptability Test Desmodur N75 BA/X', function () {
		...
		it(i + ' - Type a solution lot desmodur', function () {
			cy.get('#desLot').type('01217008', { delay: 100 });
			cy.wait(1000);
			cy.get('#desLot').type('{enter}');
			cy.wait(1000);
			cy.get('#desDue').should('be.disabled');
		...
		i++;
		it(i + ' - Type a wrong solution lot Dowanol', function () {
		...
		i++;
		it(i + " - Display error 'Solution lot not found'", function () {
			cy.get('#descDow').contains('Solution lot not found');
			cy.wait(2000);
			cy.screenshot();
			cy.get('#dowDue').should('be.disabled');
			cy.get('#trimet').should('be.disabled');
		...
		i++;
		it(i + ' - Type a correct solution lot Dowanol', function () {
			cy.get('#dowLot').clear();
			cy.get('#dowLot').type('0000097303', { delay: 100 });
			cy.wait(1000);
			cy.get('#dowLot').type('{enter}');
			cy.wait(1000);
		...
		it(i + ' - Type a solution lot trimethylpentane', function () {
			cy.get('#triLot').type('01177253', { delay: 100 });
			cy.wait(1000);
			cy.get('#triLot').type('{enter}');
			cy.wait(1000);
		...
		it(i + ' - Type a wrong Scale ED', function () {
			cy.get('#ed').type('ED11068-010', { delay: 100 });
			cy.screenshot();
			cy.get('#ed').type('{enter}');
			cy.wait(1000);
		});
		...
		it(i + " - Display error message 'ED not found'", function () {
			cy.get('#swal2-title').contains('ED not found');
			cy.wait(2000);
			cy.screenshot();
			cy.get('button').contains('OK').click();
			cy.wait(2000);
		...
		it(i + ' - Type a Scale ED with expired calibration', function () {
			cy.get('#ed').clear();
			cy.get('#ed').type('ED2119-016', { delay: 100 });
			cy.screenshot();
			cy.get('#ed').type('{enter}');
			cy.wait(1000);
		});
		...
		describe('Crosslinker Mix', function () {
			...
			it(i + ' - Type a solution lot CX-100', function () {
				cy.get('#cxLot').type('0000085859', { delay: 100 });
				cy.get('#cxLot').type('{enter}');
				cy.wait(1000);
				cy.get('#cxDue').should('be.disabled');
				cy.get('#dowanol').should('be.enabled');
				cy.get('#dowRev').should('be.disabled');
				cy.get('#dowLot').should('be.disabled');
				cy.get('#dowDue').should('be.disabled');
				cy.get('#scale').should('be.disabled');
			...
			it(i + ' - Type a Scale ED with expired calibration', function () {
				cy.get('#scale').clear();
				cy.get('#scale').type('ED2119-003', { delay: 100 });
				cy.screenshot();
				cy.get('#scale').type('{enter}');
				cy.wait(1000);
			});
			...
			it(i + ' - Type a  Mixer ED', function () {
				cy.get('#mixer').type('ED11329-002', { delay: 100 })
				cy.get('#mixer').type('{enter}');
				cy.wait(2000);
			...
			it(i + " - Display error message 'Parameter not allowed'", function () {
				cy.get('#swal2-title').contains('Parameter not allowed');
				cy.wait(2000);
				cy.screenshot();
				cy.get('button').contains('OK').click();
				cy.wait(2000);
			...
			describe('Base Coat Mix', function () {
				...
				i++;
				it(i + ' - Type a solution lot Dowanol ', function () {
					cy.get('#dowLot').type('01216574', { delay: 100 });
					cy.wait(1000);
					cy.get('#dowLot').type('{enter}');
					cy.wait(1000);
					cy.get('#dowDue').should('be.disabled');
				...
				it(i + ' - Type a solution lot Hydak B23K', function () {
					cy.get('#hydLot').type('0000079718', { delay: 100 });
					cy.wait(1000);
					cy.get('#hydLot').type('{enter}');
					cy.wait(1000);
					cy.get('#hydDue').should('be.disabled');
				...
				it(i + ' - Type a Scale ED with expired calibration', function () {
					cy.get('#scale').clear();
					cy.get('#scale').type('ED2119-016', { delay: 100 });
					cy.screenshot();
					cy.get('#scale').type('{enter}');
					cy.wait(1000);
				});
				...
				it(i + ' - Type a Mixer ED with expired calibration', function () {
					cy.get('#mixer').clear();
					cy.get('#mixer').type('ED11419-00-1454', { delay: 100 });
					cy.screenshot();
					cy.get('#mixer').type('{enter}');
					cy.wait(1000);
				});
				...
				it(i + " - Display error message 'Error, not enough time'", function () {
					cy.get('#swal2-title').contains('Error, not enough time');
					cy.wait(2000);
					cy.screenshot();
					cy.get('button').contains('OK').click();
					cy.wait(1000);
